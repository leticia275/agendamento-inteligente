...
export default async function RodizioMenosPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-lg mx-auto px-4 py-10">
        <div className="mb-6">
          <h1 className="text-xl font-semibold text-brand" style={{ fontFamily: "Georgia, serif" }}>Rodízio Minus</h1>
          <p className="text-sm text-zinc-500 mt-1">
            Faturamento abaixo de R$12k — vendedor selecionado automaticamente
          </p>
        </div>
